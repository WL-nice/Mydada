...
import com.wanglei.Mydadabackend.model.request.question.QuestionAnswerDTO;
...
public class AiTestScoringStrategy implements ScoringStrategy {
    ...
    private static final String AI_TEST_SCORING_SYSTEM_MESSAGE = "你是一位严谨的判题专家，我会给你如下信息：\n" +
            ...
            "1. 要求：需要给出一个明确的评价结果，包括评价名称（尽量简短，类似于 ISTJ（物流师）或者 INFP（治愈者））和评价描述（尽量详细，大于 200 字）\n" +
    ...
    public UserAnswer doScore(List<String> choices, App app) {
        ...
        // AI 生成
        String result = aiManager.doSyncRequest(AI_TEST_SCORING_SYSTEM_MESSAGE, userMessage);
        // 截取需要的 JSON 信息
